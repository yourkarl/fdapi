...
![RadiationPoint 示意图](/img/refdoc/api/RediationPoint.Update.gif)
...
| `coordinate` | `array` | 是 | - | 坐标点，[取值示例](/docs/tutorials/coordinates) |
| `radius` | `number` | 是 | - | 辐射圈的半径，取值范围：[0~500000]，单位：米 |
| `rippleNumber` | `number` | 是 | - | 波纹数量，取值范围：[0~5]，单位：个 |
| `color` | [`Color`](/docs/api/types#color) | 是 | - | 颜色，支持四种格式，[取值示例](/docs/tutorials/color) |
| `intensity` | `number` | 是 | - | 亮度，取值范围：[0~1.0] |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `ids` | `string \| array` | 是 | - | 要删除的RadiationPoint对象的ID或者ID数组（可以删除一个或者多个） |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `ids` | `string \| array` | 是 | - | RadiationPoint对象的ID或者ID数组 |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `ids` | `string \| array` | 是 | - | 要获取的RadiationPoint对象ID或者ID数组（可以获取一个或者多个） |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `id` | `string` | 是 | - | RadiationPoint对象的ID |
| `newVal` | `boolean` | 是 | - | 自动判断下方是否有物体，设置正确高度 true/false |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
```js
await fdapi.radiationPoint.setAutoHeight('对象ID', true);
```
...
```js
await fdapi.radiationPoint.setBrightness('对象ID', 0);
```
...
```js
await fdapi.radiationPoint.setColor('对象ID', '示例值');
```
...
|------|------|:----:|--------|------|
| `id` | `string` | 是 | - | RadiationPoint对象的ID |
| `newVal` | `array` | 是 | - | 新的坐标值，[取值示例](/docs/tutorials/coordinates) |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
```js
await fdapi.radiationPoint.setCoordinate('对象ID', []);
```
...
|------|------|:----:|--------|------|
| `id` | `string` | 是 | - | RadiationPoint对象的ID |
| `newVal` | `number` | 是 | - | 辐射圈新的半径，取值范围：[0~500000]，单位：米 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
```js
await fdapi.radiationPoint.setRadius('对象ID', 0);
```
...
|------|------|:----:|--------|------|
| `id` | `string` | 是 | - | RadiationPoint对象的ID |
| `newVal` | `number` | 是 | - | 新波纹数量，取值范围：[0~5]，单位：个 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
```js
await fdapi.radiationPoint.setRippleNumber('对象ID', 0);
```
