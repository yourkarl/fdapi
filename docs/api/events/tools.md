...
title: Tools
sidebar_label: Tools
description: "工具类 一般通过api.tools调用其方法"
---
...
### `riverCrossSectionByShp(option, fn)`
...
### `showClipPanel(clipType, screenPosition, fn)`
...
### `showMeasurePanel(measureType, screenPosition, fn)`
...
### `showUIPanel(type, screenPosition, fn)`
