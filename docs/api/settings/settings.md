...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `enable` | `boolean` | 否 | false | 是否开启鼠标右键的点击拾取，默认值：false |
...
```js
await fdapi.settings.enableRightClickMousePick(false);
```
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `ambientFadeDistance` | `number` | 否 | 12000 | 环境光遮罩的淡出距离（单位：米），默认值：12000 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `ambientIntensity` | `number` | 否 | 60 | 环境光遮罩强度，取值范围：[0~100]，默认值：60 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `ambientRadius` | `number` | 否 | 100 | 环境光遮罩采样半径，默认值：100 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `antiAliasing` | `boolean` | 否 | true | 是否开启反走样，默认值：true |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `aperture` | `number` | 否 | 4 | 光圈值（f 值），值越小景深越浅，默认值：4 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `bloomIntensity` | `number` | 否 | 0 | 泛光强度，取值范围：[0~10.0]，默认值：0 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `enable` | `boolean` | 否 | true | 设置双击右键是否开启相机自传，取值：true 启用，false 禁用，默认值：true |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
```js
await fdapi.settings.setCameraAutoRotateOnRightDoubleClick(true);
```
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `left` | `number` | 是 | - | 指北针距离视频流左侧原点像素距离，类似CSS内绝对定位left，注意：如果设置为负值则恢复到原始位置。 |
| `top` | `number` | 是 | - | 指北针距离视频流上方原点像素距离，类似CSS内绝对定位top，注意：如果设置为负值则恢复到原始位置。 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `assetPath` | `string` | 是 | - | 自定义打包pak文件内的人物角色模型路径，可以通过getCharacterAssetPath()方法查询获取 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `location` | `array` | 是 | - | 人物落脚点 |
| `rotation` | `array` | 是 | - | 人物朝向 |
| `distance` | `number` | 是 | - | 相机观察人物的距离 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `chromaticAberration` | `number` | 否 | 0（关闭 | 色差强度值，取值范围：[0~5]，默认值：0（关闭） |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `contrast` | `number` | 否 | 10 | 对比度，取值范围：[0~100]，默认值：10 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `darkCorner` | `number` | 否 | 0 | 暗角强度（百分比），取值范围：[0~1]，默认值：0 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `deepBlur` | `number` | 否 | 2 | 深度模糊强度，默认值：2 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `depthFiethSwitch` | `boolean` | 否 | false | 是否启用景深效果，默认值：false |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `dofMode` | `number` | 否 | 0 | 对焦距离模式，取值：0【近距离 0.5km】1【中远距离 2km】2【中远距离 5km】3【远距离 10km】，默认值：0 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `assetPath` | `string` | 是 | - | 自定义打包pak文件内的无人机模型路径，可以通过getDroneAssetPath()方法查询获取 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `bEnable` | `boolean` | 是 | - | 是否开启相机移动事件 |
| `period` | `number` | 否 | - | 可选参数，事件触发的间隔帧数，默认间隔：20帧，即每20帧返回一次事件，注意：值越小事件返回的越快，取值范围：[0~100] |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `bEnable` | `boolean` | 是 | - | 是否开启鼠标交互 |
| `fn` | `function` | 否 | - | 可选的回调函数。 注意：对于Cloud二次开发，此参数无效。 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `exposureCompensation` | `number` | 否 | 0 | 曝光补偿量，默认值：0 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `exposureEnabled` | `boolean` | 否 | false | 是否启用自动曝光，默认值：false |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `focalLength` | `number` | 否 | 10000 | 焦距值（单位：毫米），默认值：10000 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `fovX` | `number` | 是 | - | 水平视场角 取值范围：[10~135] 单位：度 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `receiveDecalMode` | `number` | 否 | 1 | 对象贴合模式，取值：0【无】 1【所有对象】 2【仅地形】，默认值：1 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
```js
await fdapi.settings.setImageryLayerEnableDecal(1);
```
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `levelOffset` | `number` | 是 | - | 网络图层服务当前某处的裂分等级的偏移量 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `mode` | `number` | 否 | 0 | 五种交互模式，取值范围：[0,1,2,3,4]，默认值：0；【0：漫游，1：人物，2：无人机，3：中心漫游（物体观察），4：地图】 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `name` | `string` | 是 | - | VTPK标注名称，标注名称可以根据getVTPK()查询获取。 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
```js
await fdapi.settings.setLabelLayer('名称');
```
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `depthTestHeight` | `number` | 否 | 2000米 | 深度检测的相机高度阈值，高于此值不再进行深度检测，标签将不会被遮挡；低于该高度，绘制标签会做深度检测，会有正确的遮挡关系。默认值：2000米，单位：米 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `lineSpace` | `number` | 否 | 250 | 线性标注间隔，单位：米，取值范围：[0~1000]，默认值：250 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `scale` | `number` | 否 | 100 | VTPK标注的标注缩放显示比例，百分比，取值范围：[0~1000]，默认值：100 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `type` | `number` | 是 | - | 符号避让三种方式，取值范围：[0,1,2]，取值说明：0避让 1堆叠 2使用样式文件 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `lensFlareIntensity` | `number` | 否 | 0 | 光晕强度，取值范围：[0~1.0]，默认值：0 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `lutIntensity` | `number` | 否 | 0 | LUT 调色强度（百分比小数），取值范围：[0~1.0]，默认值：0 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `lutMode` | `number` | 否 | 0 | LUT 调色预设模式，取值范围：[0~30]，0 表示关闭，1~30 对应不同 LUT 调色效果，默认值：0 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `left` | `number` | 是 | - | 左侧资源面板距离视频流左侧屏幕原点像素距离，类似CSS内绝对定位left，注意：如果设置为0则恢复到原始位置。 |
| `top` | `number` | 是 | - | 左侧资源面板距离视频流上方屏幕原点像素距离，类似CSS内绝对定位top，注意：如果设置为0则恢复到原始位置。 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
```js
await fdapi.settings.setMainPanelPos(0, 0);
```
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `time` | `number` | 否 | 1s | 鼠标悬浮事件返回的时间间隔，单位：秒，默认值：1s |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `time` | `number` | 否 | 1s | 鼠标移动事件返回的时间间隔，单位：秒，默认值：1s |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `mask` | `number` | 是 | - | 掩码，请参考`MousePickMask` |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `speed` | `number` | 否 | 0.2 | 交互移动速度 取值范围：[0~1.0]，值越大移动速度越快，默认值：0.2 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `osgbGlobalAlpha` | `number` | 否 | 1.0 | 倾斜摄影模型不透明度，取值范围：[0~1.0]，默认值：1.0 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `osgbGlobalLitStatus` | `boolean` | 否 | false | 倾斜摄影模型是否参与全局光照，默认值：false |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `name` | `string` | 是 | - | 角色或者无人机上方显示的文字名称 |
| `size` | `number` | 是 | - | 角色或者无人机上方显示的文字尺寸 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `postProcessEffects` | `number` | 否 | 0 | 滤镜效果类型，取值：0【无效果】1【景深效果】2【线框效果】3【圆珠笔】4【白框】5【蓝图】6【原色黑边】，默认值：0 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `left` | `number` | 是 | - | 属性面板距离视频流左侧屏幕原点像素距离，类似CSS内绝对定位left，注意：如果设置为0则恢复到原始位置。 |
| `top` | `number` | 是 | - | 属性面板距离视频流上方屏幕原点像素距离，类似CSS内绝对定位top，注意：如果设置为0则恢复到原始位置。 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
```js
await fdapi.settings.setPropertiesPanelPos(0, 0);
```
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `bEnable` | `boolean` | 否 | false | 多客户端访问时鼠标是否渲染同步显示，默认值：false |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
```js
await fdapi.settings.setRenderedCursorVisible(false);
```
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `viewMode` | `number` | 否 | 0 | 角色漫游采用的视角类型，取值范围：[0,1]，0角色漫游使用第三人称，1角色漫游使用第一人称，默认值：0 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `gender` | `number` | 否 | 0 | 第三人称交互是否使用男性角色，取值范围：[0,1]，0女性角色，1男性角色，默认值：0 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `saturation` | `number` | 否 | 10 | 饱和度，取值范围：[0~100]，默认值：10 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
```js
await fdapi.settings.setScreenControlsVisible(true);
```
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `screenPercentage` | `number` | 否 | 125 | 屏幕渲染分辨率百分比，取值范围：[50~200]，默认值：125 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `terrainGlobalAlpha` | `number` | 否 | 1.0 | 地形不透明度，取值范围：[0~1.0]，默认值：1.0 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `terrainGlobalLitStatus` | `boolean` | 否 | true | 地形是否参与全局光照，默认值：true |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `tonemapper` | `boolean` | 否 | true | 是否开启色彩优化，默认值：true |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `data` | `array` | 是 | - | WMTS图层服务透明度设置，参数类型：二维数组对象，数组元素index[0]：WMTS服务id 字符串id ；数组元素index[1]：不透明度 数值[0~1] ，详细描述如下： id &#123;string&#125; 即WMTS图层服务的id，类型为字符串类型ID opacity &#123;number&#125; 图层服务不透明度，取值范围：[0~1] |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `data` | `array` | 是 | - | 控制设置地图模式时添加的WMTS网络图层服务，参数类型：二维数组，数组元素index[0]：WMTS服务id 字符串id ；数组元素index[1]：服务是否可见 boolean ；取值示例：[['111', true], ['222', false]]，打开图层服务[111] 关闭图层服务[222] |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|:----:|--------|------|
| `yawSpeed` | `number` | 否 | 1.0 | 水平视角的旋转速度 取值范围：[0~1.0]，值越大旋转速度越快，默认值：1.0 |
| `fn` | `function` | 否 | - | 可选的回调函数，请参考[二次开发：异步接口调用方式](/docs/tutorials/async-call) |
...
```js
await fdapi.settings.showPropertiesPanel('对象ID');
```
