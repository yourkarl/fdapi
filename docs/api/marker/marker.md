...
- **适用行业**：智慧城市、应急指挥、智慧交通、能源电力、智慧园区、文博展陈、智慧工地、石油化工、智慧矿山、智慧水利。
- **使用场景**：
  ...
  - 智慧工地人员实时定位、油气田井场 / 计量站点位、矿山井下人员与车辆定位，配合 update / moveTo 增量刷新状态。
  - 水资源监管取水口 / 计量点、水质断面、灌区闸站点位标注，配合 update 实时刷新取水量与水位。
- **注意事项**：
